...
function SpGetEditor($fname,$fvalue,$nheight="350",$etype="Basic",$gtype="print",$isfullpage="false",$bbcode=false)
{
    ...
    if($GLOBALS['cfg_html_editor']=='fck')
    {
        ...
        $fck->BasePath        = $GLOBALS['cfg_cmspath'].'/zitiert/FCKeditor/' ;
        $fck->Width        = '100%' ;
        $fck->Height        = $nheight ;
    ...
    else if($GLOBALS['cfg_html_editor']=='ckeditor')
    {
        ...
        $CKEditor->basePath = $GLOBALS['cfg_cmspath'].'/zitiert/ckeditor/' ;
        $config = $events = array();
        ...
        $ded->BasePath        = $GLOBALS['cfg_cmspath'].'/zitiert/htmledit/' ;
        $ded->Width        = '100%' ;
        $ded->Height        = $nheight ;

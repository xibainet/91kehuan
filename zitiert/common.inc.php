...
define('DEDEDATA', DEDEROOT.'/daten');
define('DEDETEMPLATE', DEDEROOT.'/vorlage');
...
//站点根目录
$cfg_basedir = preg_replace('#'.$cfg_cmspath.'\/zitiert$#i', '', DEDEINC);
if($cfg_multi_site == 'Y')
{
...
//模板的存放目录
$cfg_templets_dir = $cfg_cmspath.'/vorlage';

...
function SelectFlash()
{
	...
	window.open("../zitiert/dialog/select_media.php?f=form1.flashurl", "popUpFlashWin", "scrollbars=yes,resizable=yes,statebar=no,width=500,height=350,left="+posLeft+", top="+posTop);
}
...
function SelectMedia(fname)
{
	...
	window.open("../zitiert/dialog/select_media.php?f="+fname, "popUpFlashWin", "scrollbars=yes,resizable=yes,statebar=no,width=500,height=350,left="+posLeft+", top="+posTop);
}
...
function SelectSoft(fname)
{
	...
	window.open("../zitiert/dialog/select_soft.php?f="+fname, "popUpImagesWin", "scrollbars=yes,resizable=yes,statebar=no,width=600,height=400,left="+posLeft+", top="+posTop);
}
...
function SelectImage(fname,stype,imgsel)
{
	...
	if(!stype) stype = '';
	window.open("../zitiert/dialog/select_images.php?f="+fname+"&noeditor=yes&imgstick="+stype+imgsel, "popUpImagesWin", "scrollbars=yes,resizable=yes,statebar=no,width=650,height=400,left="+posLeft+", top="+posTop);
}
...
function SelectImageN(fname,stype,vname)
{
	...
	if(!fname) fname = 'form1.picname';
	if(!stype) stype = '';
	window.open("../zitiert/dialog/select_images.php?f="+fname+"&imgstick="+stype+"&v="+vname, "popUpImagesWin", "scrollbars=yes,resizable=yes,statebar=no,width=600,height=400,left="+posLeft+", top="+posTop);
}

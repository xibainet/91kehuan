...
require_once(dirname(__FILE__)."/../zitiert/dedemodule.class.php");
require_once(dirname(__FILE__)."/../zitiert/oxwindow.class.php");
...
if($action=='upload')
{
    ...
    {
        include_once(dirname(__FILE__)."/../zitiert/zip.class.php");

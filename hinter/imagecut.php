...
if(empty($action))
{
    ...
    {
        ShowMsg("对不起，必须选择站内的图片才能进行裁剪！<br />点击'<a href='/include/dialog/select_images.php?f=form1.picname&imgstick=small'>站内选择</a>', 上传或选择一个图片，然后才能进行裁剪！", "../zitiert/dialog/select_images.php?f=form1.picname&imgstick=small", 0 , 10000);
        exit();
    }

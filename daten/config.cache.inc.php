...
$cfg_cmspath = '';
$cfg_cookie_encode = 'FTKUmSmfkU1WiydcI9LWGarOMRTOR';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '铀科幻';
$cfg_webname = '【铀科幻】裂变科幻资讯';
$cfg_adminemail = 'admin@dedecms.com';
$cfg_html_editor = 'ckeditor';
$cfg_arcdir = 'html';
$cfg_medias_dir = '/uploads';
$cfg_ddimg_width = 2000;
$cfg_ddimg_height = 2000;
$cfg_domain_cookie = '';
...
$cfg_multi_site = 'Y';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2006 honeyswedding. 哈尼时尚婚礼 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
$cfg_arcautosp_size = 5;
$cfg_auot_description = 2000;
$cfg_ftp_host = '';
$cfg_ftp_port = 21;
$cfg_ftp_user = '';
$cfg_ftp_pwd = '';
...
$cfg_tplcache = 'Y';
$cfg_tplcache_dir = '/daten/tplcache';
...
$cfg_rewrite = 'N';
$cfg_delete = 'N';
$cfg_keywords = '铀科幻,科幻资讯,科幻热点,脑洞前沿,数码鲜货,科技百科,报广图书,科幻影剧,电竞游戏,铀社群';
$cfg_description = '铀科幻是为科幻爱好者们提供的资讯平台，聚合全网科幻最新相关内容，涵盖数码、百科、图书、电影、电视剧、游戏等，根据用户的喜好提供最适合的优质科幻信息分类优选平台。';
$cfg_beian = '津ICP备17001197号-2';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
